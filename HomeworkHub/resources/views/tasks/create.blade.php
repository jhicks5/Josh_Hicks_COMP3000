                ...
                <div class="card-body">
                    <form action="/t" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" title="title" value="{{ old('title') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" title="description" value="{{ old('description') }}" autofocus>
