    ...
    <div class="row pb-5 pt-2">
        <div class="col-lg-10" >
            <div class="d-flex justify-content-between pb-2">
                <h4>INDEX Homework Tasks for {{ $classroom->classname }}</h4>
            ...
            <div class="list-group">
                @foreach($classroom->task as $task)
                    <a href="/t/{{ $task->id }}" class="list-group-item list-group-item-action flex-column align-items-start">
                        ...
                        <p class="mb-1 col-6">{{ $task->description }}</p>
                    </a>
                @endforeach
            </div>
        </div>
